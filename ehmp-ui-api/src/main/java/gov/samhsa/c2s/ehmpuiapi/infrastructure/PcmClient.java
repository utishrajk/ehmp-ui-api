package gov.samhsa.c2s.ehmpuiapi.infrastructure;

import gov.samhsa.c2s.ehmpuiapi.infrastructure.dto.ConsentAttestationDto;
import gov.samhsa.c2s.ehmpuiapi.infrastructure.dto.ConsentDto;
import gov.samhsa.c2s.ehmpuiapi.infrastructure.dto.ConsentProviderDto;
import gov.samhsa.c2s.ehmpuiapi.infrastructure.dto.ConsentRevocationDto;
import gov.samhsa.c2s.ehmpuiapi.infrastructure.dto.ConsentTermDto;
import gov.samhsa.c2s.ehmpuiapi.infrastructure.dto.DetailedConsentDto;
import gov.samhsa.c2s.ehmpuiapi.infrastructure.dto.IdentifiersDto;
import gov.samhsa.c2s.ehmpuiapi.infrastructure.dto.PageableDto;
import gov.samhsa.c2s.ehmpuiapi.infrastructure.dto.PcmConsentActivityDto;
import gov.samhsa.c2s.ehmpuiapi.infrastructure.dto.PurposeDto;
